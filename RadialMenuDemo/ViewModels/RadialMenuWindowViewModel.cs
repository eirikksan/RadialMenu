...
{
    public class RadialMenuWindowViewModel : INotifyPropertyChanged
    {
        private readonly IWindowService _windowService;

        public ICommand OpenNewWindowCommand { get; }

        public RadialMenuWindowViewModel(IWindowService windowService)
        {
        ...
        {
            _windowService.ShowWindowAtMousePosition<RadialMenuDemo.RadialMenuWindow>();
        }
